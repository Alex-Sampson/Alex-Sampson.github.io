function [z]=Uvmult_row(M,v,z,n)

%
% Inner product version of in-place z=U*v
...
%
% the i loop goes over the elements of the output vector z
%
% Row i of U has its possibly nonzero elements in positions  (i,i:n).
